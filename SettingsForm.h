...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->UstGroupBox->Text = L"Юстировка";
			// 
			// label4
			// 
			...
			this->UpdateBtn->Text = L"Обновить";
			...
			this->groupBox3->Text = L"Назначить номер колонке:";
			// 
			// CastBtn
			// 
			...
			this->ComOpenButn->Text = L"Открыть порт";
			...
			this->checkLog->Text = L"Вести лог обмена";
			...
			this->label8->Text = L"Настройки для колонки №";
			// 
			// KolNumBox
			// 
			...
			this->button3->Text = L"Принять номер";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e); // Залить
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e); // Залито
	   bool kSended;
...
private: System::Void CastBtn_Click(System::Object^ sender, System::EventArgs^ e);
	   String^ setKolNumStr;
	   int setKolNum;
private: System::Void button3_Click_1(System::Object^ sender, System::EventArgs^ e) { // KolNumBox "Принять номер"
	setKolNumStr = KolNumBox->Text;
	setKolNum = Convert::ToInt32(setKolNumStr);
	String^ t = "Настройки будут для колонки №" + setKolNumStr + "."; // +setKolNum.ToString();
	MessageBox::Show(t, "Назначить");
}
...
private: System::Void ResetBtn_MouseHover(System::Object^ sender, System::EventArgs^ e) {
	AllToolTip->SetToolTip(ResetBtn, "RESET колонку");
}
...
private: System::Void SettingsForm_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
	...
	//UstGroupBox->Text = "Юстировка: " + key;
