...
namespace AGZS {
	...
	public:
		MainForm(void)
		{
			...
			toolStripMenuItem8->Click += gcnew System::EventHandler(this, &MainForm::SetKKMBtn_Click); // L"Настройки ЧПM"
			//smenaToolStripMenuItem->Click += gcnew System::EventHandler(this, &MainForm::SmenaMenu_Click);
			toolStripMenuItem9->Click += gcnew System::EventHandler(this, &MainForm::SmenaMenu_Click); // L"Сменить оператора..."
			toolStripMenuItem10->Click += gcnew System::EventHandler(this, &MainForm::CloseSmena_Click); // L"Закрыть смену"
			toolStripMenuItem11->Click += gcnew System::EventHandler(this, &MainForm::SetAddBtn_Click); // L"Дополнительные настройки"
			//
			...
			FuelTimer->Interval = 33;
			delayed = gcnew List<String^>(0);
			FuelTimer->Start();
		}
...
private: System::Windows::Forms::ToolStripMenuItem^ toolStripMenuItem11;
	...
	public: System::IO::Ports::SerialPort^ serialPort1;
		  System::Void PortWrite(int n, String^ s);
		  System::Void PortWrite(int n, wchar_t c);
		  System::Void PortWrite2all(String^ s);
		  System::Void LogReceived(String^ s);
	private:
		String^ sWrtd; // Last Writed to Port
		double lastL, lastS;
	...
	public:
		void StartFuel(int kNum, double data, String^ modeStr); // modeStr for AddAction(LogedAs, "StartFuel", modeStr);
		void StopFuel(void);
	...
	private: // From ./AGZS.ini:
		...
		String^ LogedAs;
		String^ ComKKM;
		void BeginSmena(int Lvl, String^ Usr);
		void EndSmena(void);
	...
	public:
		...
		void ShowFuiledIn(Microsoft::Office::Interop::Excel::Worksheet^ ews, String^ forUser);
		void ShowActionsIn(Microsoft::Office::Interop::Excel::Worksheet^ ews, String^ forUser);
		void SaveExcel( bool doVisible, String^ fn);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->FuelTimer = (gcnew System::Windows::Forms::Timer(this->components));
			...
			this->KolPanel->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MainForm::KolPanel_Paint);
			// 
			// serialPort1
			// 
			...
			// toolStripMenuItem1
			// 
			this->toolStripMenuItem1->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(8) {
				this->toolStripMenuItem2,
					...
					this->toolStripMenuItem11, this->toolStripMenuItem6
			});
			...
			this->toolStripMenuItem2->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem2->Text = L"Настройки";
			// 
			// toolStripMenuItem3
			// 
			this->toolStripMenuItem3->Name = L"toolStripMenuItem3";
			this->toolStripMenuItem3->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem3->Text = L"Операторы";
			// 
			// toolStripMenuItem4
			// 
			this->toolStripMenuItem4->Name = L"toolStripMenuItem4";
			this->toolStripMenuItem4->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem4->Text = L"Информация";
			// 
			// toolStripMenuItem5
			// 
			this->toolStripMenuItem5->Name = L"toolStripMenuItem5";
			this->toolStripMenuItem5->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem5->Text = L"Добавить ТРК";
			// 
			// toolStripMenuItem7
			// 
			this->toolStripMenuItem7->Name = L"toolStripMenuItem7";
			this->toolStripMenuItem7->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem7->Text = L"Удалить ТРК";
			// 
			// toolStripMenuItem8
			// 
			this->toolStripMenuItem8->Name = L"toolStripMenuItem8";
			this->toolStripMenuItem8->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem8->Text = L"Настройки ЧПМ";
			// 
			// toolStripMenuItem11
			// 
			this->toolStripMenuItem11->Name = L"toolStripMenuItem11";
			this->toolStripMenuItem11->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem11->Text = L"Дополнительные настройки";
			// 
			// toolStripMenuItem6
			// 
			this->toolStripMenuItem6->Name = L"toolStripMenuItem6";
			this->toolStripMenuItem6->Size = System::Drawing::Size(218, 22);
			this->toolStripMenuItem6->Text = L"Выход";
			// 
			// smenaToolStripMenuItem
			// 
			this->smenaToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
			...
			this->toolStripMenuItem9->Size = System::Drawing::Size(186, 22);
			this->toolStripMenuItem9->Text = L"Сменить оператора...";
			// 
			// toolStripMenuItem10
			// 
			this->toolStripMenuItem10->Name = L"toolStripMenuItem10";
			this->toolStripMenuItem10->Size = System::Drawing::Size(186, 22);
			this->toolStripMenuItem10->Text = L"Закрыть смену";
			// 
			// FuelTimer
			// 
			this->FuelTimer->Tick += gcnew System::EventHandler(this, &MainForm::FuelTimer_Tick);
			// 
			// MainForm
			// 
...
#pragma endregion
	...
	private: System::Void SetKKMBtn_Click(System::Object^ sender, System::EventArgs^ e);
		   System::Void SetAddBtn_Click(System::Object^ sender, System::EventArgs^ e);
...
private: System::Void SmenaMenu_Click(System::Object^ sender, System::EventArgs^ e);
	System::Void CloseSmena_Click(System::Object^ sender, System::EventArgs^ e);
...
public: System::Void SendReset(int n); // '&'
	  System::Void SendBright( Decimal n, Decimal b);
private: System::Void FuelTimer_Tick(System::Object^ sender, System::EventArgs^ e);
private: System::Void KolPanel_Paint(System::Object^ sender, System::Windows::Forms::PaintEventArgs^ e) {}
};
}
